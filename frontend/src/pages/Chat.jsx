            ...
            <SocketContext.Provider value={socket}>
                <div className="Chat">
                    ...
                    <form className="form d-flex flex-row" onSubmit={handleSubmit}>
                        <input className="inp input-group-text form-control " onChange={event => setMessage(event.target.value)} placeholder="Entrez votre message" /><button className="button btn btn-outline-success">Send</button>
                    </form>
